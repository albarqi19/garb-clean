...
namespace App\Filament\Admin\Resources\CircleOpeningRequestResource\RelationManagers;
...
class CircleRequestActivitiesRelationManager extends RelationManager
{
    protected static string $relationship = 'circleRequestActivities';
