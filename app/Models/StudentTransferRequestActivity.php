...
class StudentTransferRequestActivity extends Model
{
    use HasFactory;
     ...
     *
     * @param StudentTransferRequest $request طلب النقل
     ...
     * @return StudentTransferRequestActivity
     */
    public static function addActivity(StudentTransferRequest $request, $activityType, $userId = null, $role = null, $notes = null): self
    {
        return self::create([
